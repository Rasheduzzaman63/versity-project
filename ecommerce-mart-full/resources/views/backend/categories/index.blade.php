...
@section('content')
            ...
            <div class="col-lg-12 pt-2">
                <div class="card">
                    <div class="card-header bg-info">
                        <h3 class="card-title d-inline-block">Category List</h3>
                        <a href="javascript:void(0)" class="float-right btn btn-primary btn-sm" id="create-new-Category"
                            onclick="addCategory()">
    ...
    <!-- Add data -->
    <div class="modal fade" id="Category-create-modal" aria-hidden="true">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#edit_form').submit(function(e) {
                ...
                let _url = `categories/` + Category_id;
