            ...
            <div class="panel-body">
                <form class="form-horizontal" method="POST" action="{{route('categories.update', $Category->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input class="form-control" type="text" name="created_by" id="created_by" value="{{ old('created_by', $Category->created_by) }}" >
                        ...
                        <div class="col-md-3">
                            <input class="form-control" type="text" name="updated_by" id="updated_by" value="{{ old('updated_by', $Category->updated_by) }}" >
